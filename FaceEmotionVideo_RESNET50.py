...
# El modelo se basa en la arquitectura RESNET50V2 y ha sido entrenado con un conjunto de datos de imágenes faciales etiquetadas con emociones extraidos de FER2013.
...
emotionModel = load_model("./models/RESNET50/emotion_recognition_resnet50v2.keras")
...
def predict_emotion(frame, faceNet, emotionModel):
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > 0.4:
            ...
            # Cambios para adaptarse al modelo
            face = cv2.cvtColor(face, cv2.COLOR_BGR2RGB)  # Convertir a RGB
            face = cv2.resize(face, (224, 224))  # Redimensionar a 224x224
